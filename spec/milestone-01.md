...
the archived execution notes are not the current blocker list.
...
Earlier progress narration is preserved in the
[2026-09-17 archive](../docs/checkpoints/2026-09-17-m1-execution-history.md).
Use the delivery checklist and current acceptance gates for present status.
The archive does not grant execution authority or establish M1 acceptance.
